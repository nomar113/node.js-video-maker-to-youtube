...
async function robot() {
    ...
    async function uploadVideo(content) {
        ...
        function onUploadProgress(event) {
            ...
            console.log(`> [youtube-robot] ${event.bytesRead}/${videoFileSize}: ${progress}% completed`)
        }
    ...
    async function uploadThumbnail(videoInformation) {
        ...
        const videoThumnailFilePath = './content/youtube-thumbnail.jpg'

        const requestParameters = {
            videoId: videoId,
            media: {
                mimeType: 'image/jpeg',
                body: fs.createReadStream(videoThumnailFilePath)
            }
        }
